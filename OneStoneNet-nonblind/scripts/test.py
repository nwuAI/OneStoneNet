...
def main():
    ...
    state_dict = th.load(args.model_path,map_location=th.device('cuda:1'))
    ...
    state_dict1 = th.load(args1.model_path,map_location=th.device('cuda:1'))
